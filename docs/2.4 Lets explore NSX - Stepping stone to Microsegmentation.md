...
4.	Add the IP of mhack-debian-DFW1  VM IP to this group and the press apply
...
7.	Click the IP addresses and then provide the IP address of the AVS mhack-debian-DFW2 VM and then press apply
...
17.	Now ping the mhack-debian-DFW2 VM from mhack-debian-DFW1 VM. We should notice that the ping is blocked
